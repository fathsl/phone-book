	...
	translate(keys, o, lastKey) {
		...
		if (handleAsObjectInI18nFormat && resForObjHndl && handleAsObject && noObject.indexOf(resType) < 0 && !(isString(joinArrays) && Array.isArray(resForObjHndl))) {
			...
			if (keySeparator) {
				...
				const copy$1 = resTypeIsArray ? [] : {};
				const newKeyToUse = resTypeIsArray ? resExactUsedKey : resUsedKey;
				for (const m in resForObjHndl) if (Object.prototype.hasOwnProperty.call(resForObjHndl, m)) {
					const deepKey = `${newKeyToUse}${keySeparator}${m}`;
					if (hasDefaultValue && !res) copy$1[m] = this.translate(deepKey, {
						...opt,
						defaultValue: shouldHandleAsObject(defaultValue) ? defaultValue[m] : void 0,
						joinArrays: false,
						ns: namespaces
					});
					else copy$1[m] = this.translate(deepKey, {
						...opt,
						joinArrays: false,
						ns: namespaces
					});
					if (copy$1[m] === deepKey) copy$1[m] = resForObjHndl[m];
				}
				res = copy$1;
			}
...
var Interpolator = class {
	...
	nest(str, fc, options = {}) {
		...
		const handleHasOptions = (key, inheritedOptions) => {
			...
			const c = key.split(/* @__PURE__ */ new RegExp(`${sep}[ ]*{`));
...
var I18n = class I18n extends EventEmitter {
	...
	static createInstance(options = {}, callback) {
		const instance$1 = new I18n(options, callback);
...
//#endregion
export { getFixedT as a, instance as c, loadNamespaces as d, loadResources as f, use as g, t as h, exists as i, keysFromSelector as l, setDefaultNamespace as m, createInstance as n, hasLoadedNamespace as o, reloadResources as p, dir as r, init as s, changeLanguage as t, loadLanguages as u };
//# sourceMappingURL=i18next-sQ9ojFve.js.map